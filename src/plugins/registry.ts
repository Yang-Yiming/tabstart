...
/* ------------------------------------------------------------------ */
/* Discovery: registry.generated.ts is generated by `plugin:sync` from  */
/* src/plugins/plugin.config.json. Disabled plugins are excluded from    */
/* the bundle and from tsc via tsconfig.app.json exclude.                */
/* ------------------------------------------------------------------ */

import { enabledPluginModules } from './registry.generated'

/** All build-time plugin descriptors, in display order. */
export const pluginDescriptors: HomepagePlugin[] = enabledPluginModules
